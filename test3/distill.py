...
def run_pipeline(
    *,
    ...
    if need_label:
        ...
        teacher_labeler.label_samples(train_set, "labeled_data.jsonl")
        if val_ratio:
            teacher_labeler.label_samples(val_set, "val_labeled_data.jsonl")
    else:
    ...
    # 6) 强化学习微调
    ppo_cfg = train_ppo.RLConfig(
        model_path=output_dir,
        data_path=train_jsonl,
        epochs=1,
        batch_size=1,
    )
    train_ppo.main(ppo_cfg)
